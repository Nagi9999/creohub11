...
const Catego = () => {
  ...
  key={item}
  virtualIndex={index}
  className="slide1 flex flex-col justify-between sm:pl-4 pl-3  sm:pr-8 pr-6 sm:py-10 py-3 custom-white0   sm:rounded-[20px] rounded-[7.4px] sm:mx-1 mx-0 text-justify   sm:my-8 my-4 cursor-pointer"
>
  <img
    src={item.icon}
    alt="Your Icon"
